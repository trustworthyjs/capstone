...
async function seed () {
  ...
  const users = await Promise.all([
    ...
    User.create({email: 'lizzy@email.com', password: '123', streakGoalDate: new Date('April 17, 2018'), streakGoalStart: new Date('January 29, 2018'), currentStreak: 17, maxStreak: 17})
  ])
